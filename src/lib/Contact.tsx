...
export function Lad() {
    return (
        ...
        <h1 className='font-semibold text-white'>Contact:</h1>
            ...
            <div className=" p-4 max-w-5xl  mx-auto relative z-10  w-full pt-4 md:pt-0">
